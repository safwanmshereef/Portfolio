  ...
  return (
    <div className="w-full max-w-4xl mx-auto my-32 relative border-8 border-sunset-orange/50 rounded-lg overflow-hidden h-[400px] bg-[#0d1117] shadow-[0_0_40px_rgba(249,115,22,0.3)] interactive select-none">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-40">
         <div className={`absolute bottom-[40px] w-[200%] h-full flex ${isPlaying && !gameOver ? 'animate-[slide_10s_linear_infinite]' : ''}`}>
             <div className="w-1/2 h-full bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] bg-repeat" />
             <div className="w-1/2 h-full bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] bg-repeat" />
         </div>
      </div>

      {/* Floor */}
      <div className="absolute bottom-0 w-full h-[40px] bg-slate/80 border-t-4 border-sunset-orange" />
      ...
      <div
        ref={characterRef}
        className="absolute w-[60px] h-[60px] z-10 transition-all duration-150"
        style={{
            left: '50px',
            bottom: isJumping ? '140px' : '40px', // Jump height
            transitionTimingFunction: isJumping ? 'cubic-bezier(0.1, 0.9, 0.2, 1)' : 'cubic-bezier(0.8, 0, 0.9, 0.1)'
        }}
      >
        <img
            src="/assets/anime/naruto.gif?v=3"
            alt="Naruto Runner"
